...
export function DataGuardBanner({ meta }: { meta: DashboardData["meta"] }) {
  ...
  if (meta.stale) return <div className="guard-banner guard-warning"><AlertTriangle size={20} /><div><strong>Coleta desatualizada</strong><span>Gere uma nova fotografia antes de tomar decisões.</span></div></div>;
  return null;
}
